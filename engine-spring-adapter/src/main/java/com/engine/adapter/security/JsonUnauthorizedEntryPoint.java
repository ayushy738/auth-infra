 ...
 * Ensures API and browser clients receive a consistent response without login redirects.
 */
public class JsonUnauthorizedEntryPoint implements AuthenticationEntryPoint {

    private static final String BODY = "{\"error\":\"Unauthorized\",\"message\":\"Authentication required\"}";
